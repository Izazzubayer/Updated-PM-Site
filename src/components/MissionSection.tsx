      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-mono leading-relaxed">
            Empowering local businesses with premium creative solutions that don't break the bank. 
        ...
        <div className="pixel-card p-12 bg-white mb-16 text-center">
          ...
          <p className="text-lg text-gray-700 font-mono max-w-4xl mx-auto leading-relaxed">
            ...
            with larger brands through exceptional design and strategic thinking.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div 
              key={index}
              className="pixel-card p-6 bg-white hover:animate-pixel-glow transition-all duration-300 text-center"
            >
              <div className="w-16 h-16 bg-mango-500 border-2 border-black mx-auto mb-4 flex items-center justify-center">
                <value.icon className="w-8 h-8 text-black" />
              </div>
              <h4 className="text-lg font-pixel text-black mb-3">{value.title}</h4>
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center pixel-card p-6 bg-white">
            <div className="text-3xl font-pixel text-black mb-2">3</div>
