  ...
  return (
    <section className="relative pt-24 pb-16 bg-gradient-to-br from-gray-50 via-white to-green-50/30 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-32 right-20 w-16 h-16 border-2 border-green-200 rotate-45 animate-spin" style={{ animationDuration: '8s' }}></div>
        <div className="absolute bottom-32 left-20 w-12 h-12 bg-gradient-to-r from-blue-200 to-purple-200 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="mb-8 p-4 bg-white/50 backdrop-blur-sm rounded-xl border border-gray-200">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200">
              <div className="text-center group cursor-pointer">
                ...
                <div className="text-sm text-gray-600 font-product group-hover:text-gray-800 transition-colors duration-300">{t('projects')}</div>
              ...
              <div className="text-center group cursor-pointer">
                ...
                <div className="text-sm text-gray-600 font-product group-hover:text-gray-800 transition-colors duration-300">{t('satisfaction')}</div>
                <div className="w-full h-1 bg-gray-200 rounded-full mt-2 overflow-hidden">
              ...
              <div className="text-center group cursor-pointer">
                ...
                <div className="text-sm text-gray-600 font-product group-hover:text-gray-800 transition-colors duration-300">{t('supportAvailable')}</div>
                <div className="w-full h-1 bg-gray-200 rounded-full mt-2 overflow-hidden">
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="relative">
              ...
              <div className="absolute top-0 left-1/4 w-2 h-2 bg-red-400 rounded-full animate-ping" style={{ animationDelay: '2s' }}></div>
              <div className="absolute bottom-0 right-1/4 w-5 h-5 border-2 border-indigo-400 rotate-45 animate-spin" style={{ animationDuration: '4s' }}></div>
            </div>
          </div>
        </div>
      </div>
