        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="pixel-card bg-white p-8">
              ...
              <div className="text-4xl font-pixel text-mango-500 mb-6">$3,999</div>
            ...
            <div className="pixel-card bg-white p-8 relative border-mango-500">
              ...
              <div className="text-4xl font-pixel text-mango-500 mb-6">$7,999</div>
              <ul className="space-y-3 mb-8">
            ...
            <div className="pixel-card bg-white p-8">
              ...
              <div className="text-4xl font-pixel text-mango-500 mb-6">$15,999</div>
              <ul className="space-y-3 mb-8">
