...
const RetouchedAI = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-product">
      <SEO
        title="Retouched.Ai - AI Background Remover"
        description="Instantly remove backgrounds from images with pixel-perfect precision using Retouched.Ai. Perfect for e-commerce, photography, and design."
        keywords="Retouched.Ai, background remover, AI background removal, image editing, transparent background, e-commerce tools, Pixel Mango products"
      />
      <Header />
      <ScrollToTop />
